...
// Library supports 4096 colors, which is pretty darn handy!!!!  :)

//Board: Arduin/Genuiono
//Programmer: USBasp
...
//Adapted to provide Temperature and Humidity from an Oregon Scientific Sensor
//by intercepting the 433MHz signal for the data.
//The onboard RTC is used to provide a timebase.

//The system was installed in the famous
//Waterwheel Beach Tavern, at Lake Tyers Beach, Victoria 3909, Australia.
//Enjoy!!!!
...
byte once = 1; //toggle so display does not strobe
...
void clock2matrix() {
  ...
  if (now.second() < 29) {
    ...
    myhour = myhour%12;
    if (myhour==0) {
      myhour = 12; //if time is 00:00hrs make it 12:00 am or pm
    }
